...
namespace VLB_Samples
{
    public class FreeCameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetKey(KeyCode.E)) { transform.position += Vector3.up   * speedClimb * Time.deltaTime; }
            if (Input.GetKey(KeyCode.Q)) { transform.position += Vector3.down * speedClimb * Time.deltaTime; }
